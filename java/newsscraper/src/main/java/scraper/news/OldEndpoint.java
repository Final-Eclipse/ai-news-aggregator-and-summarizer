...
public class OldEndpoint
{
    ...
    public OldEndpoint(String endpoint)
    {
    ...
    public OldEndpoint(String endpoint, boolean sources)
    {
        this.endpoint = endpoint;
    ...
    public OldEndpoint addQueryParameterCategory(String category)
    {
    ...
    public OldEndpoint addQueryParameterLanguage(String language)
    { 
    ...
    public OldEndpoint addQueryParameterCountry(String country)
    {
    ...
    public OldEndpoint addQueryParameterSources(String... sources)
    {
    ...
    public OldEndpoint addQueryParameterQ(String q)
    {
    ...
    public OldEndpoint addQueryParameterPageSize(int pageSize)
    {
    ...
    public OldEndpoint addQueryParameterPage(int page)
    {
    ...
    protected OldEndpoint appendQueryParameters()
    {
